...
var GET_EVENT_BY_ID string = "/api/v1/event/:id"
var CREATE_EVENT string = "/api/v1/event"
var GET_EVENT_BY_CITY string = "/api/v1/event/city"
var ADD_USER_TO_EVENT string = "/api/v1/event/:eventId/:userId"
...
var UNLIKE_MESSAGE_IN_EVENT string = "/api/v1/message/event/downvote/:eventId/:userId/:messageId"
var GET_EVENTS_MEMBER_OF string = `/api/v1/user/event/member/:userId`
var GET_EVENTS_MEMBERS string = `/api/v1/member/user/event/:eventId`
